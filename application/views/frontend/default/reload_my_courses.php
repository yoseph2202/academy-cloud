...
<div class="col-sm-6 col-md-6 col-lg-4 col-xxl-3">
  <div class="course-box-wrap p-0">
    <div class="course-box p-0">
      ...
      <div class="pb-2" id = "course_info_view_<?php echo $course_details['id'];  ?>">
        <div class="course-details">
          ...
          <small class="text-12px"><?php echo ceil(course_progress($course_details['id'])); ?>% <?php echo site_phrase('completed'); ?></small>
          <div class="rating your-rating-box text-start mt-1" style="position: unset;">
            ...
            <?php endif; ?>
            <?php endfor; ?>
            <a href="javascript:;" id = "edit_rating_btn_<?php echo $course_details['id']; ?>" onclick="toggleRatingView('<?php echo $course_details['id']; ?>')" style="color: #2a303b; float: right; font-size: 13px;"><?php echo site_phrase('edit_rating'); ?></a>
