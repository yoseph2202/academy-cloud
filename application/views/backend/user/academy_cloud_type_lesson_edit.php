...
<div class="form-group">
    ...
    <input type="text" class="form-control" data-toggle='timepicker' data-minute-step="5" name="academy_cloud_video_duration" id = "academy_cloud_video_duration" data-show-meridian="false" value="<?php echo $lesson_details['duration']; ?>">
</div>
